...
#ast-wrap{background:#f8faff;border:1px solid #e8eaf0;border-radius:8px;overflow:auto;height:100px;max-height:100px;padding:8px;margin-top:8px;cursor:grab}
