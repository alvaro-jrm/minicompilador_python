...
#ast-wrap{background:#f8faff;border:1px solid #e8eaf0;border-radius:8px;overflow:auto;height:300px;max-height:350px;width:100px;max-width:200px;padding:8px;margin-top:8px;cursor:grab}
